...
- Note that fallacious reasoning doesn't prove the conclusion false¡ªjust that this argument doesn't support it
...
2. **Design Selection**
   - Match design to question (causal ¡ú experimental; associational ¡ú observational)
